            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3 class="card-title">{{ $page_name }}</h3>
                        @permission(['All'])
                            <a href="{{ url('/admin/roles/create') }}" class="btn btn-sm btn-primary float-right">Create</a>
                        @endpermission
                    </div>
                    <div class="card-body">
                        ...
                        @foreach($data as $i=>$row)
                            ...
                            <td>
                                <a href="{{ url('/admin/roles/edit/'.$row->id) }}" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
