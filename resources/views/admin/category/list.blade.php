            ...
            <div class="col-md-12">
                ...
                @foreach($data as $i=>$row)
                    ...
                    <td>
                        ...
                        @csrf
                        @if($row->status === 1)
                        <button type="submit" class="btn btn-danger"><i class="fa fa-times"></i> Unpublished</button>
                        @else
                        <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Published</button>
                        @endif
                        </form>
                    </td>
                    <td>
